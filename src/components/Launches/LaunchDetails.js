    ...
    <Consumer>
      {contextValue => {
        ...
        <CardHeader
          ...
          title={launch.mission_name}
          subheader={new Date(Date.parse(launch.launch_date_local)).toDateString()}
        />
        <CardMedia
        ...
        <Typography component="p">
         {launch.details}
          ...
          <Typography paragraph>
            ...
            <Typography paragraph>
              Launch Site Full Name: {launch.launch_site.site_name_long}
            </Typography>
            <Typography paragraph>
        ...
        <CardContent>
          ...
          <Button color="primary"  href={launch.links.article_link} >Article</Button>
          <Button color="primary"  href={launch.links.wikipedia} >Wikipedia</Button>
          <Button color="primary"  href={launch.links.video_link} >YouTube</Button>
            </Typography>
          </CardContent>
